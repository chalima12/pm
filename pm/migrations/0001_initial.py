<<<<<<< HEAD
# Generated by Django 4.2.5 on 2023-12-01 10:27
=======
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
<<<<<<< HEAD
                ('schedule_name', models.CharField(max_length=200, null=True)),
...
>>>>>>> latest
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(blank=True, choices=[('PE', 'Pending'), ('WT', 'Waiting'), ('OP', 'Onprogress'), ('CO', 'Completed'), ('AP', 'Approved')], default='PE', max_length=10, null=True)),
                ...
                ('created_date', models.DateField(auto_now_add=True, null=True)),
<<<<<<< HEAD
                ('schedule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='pm.allschedule')),
=======
                ('assign_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('bank_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='pm.bank')),
...
>>>>>>> latest
        ...
        migrations.AddField(
            model_name='allschedule',
            name='terminal',
            field=models.ForeignKey(help_text='Select Terminal', null=True, on_delete=django.db.models.deletion.PROTECT, to='pm.terminal'),
        ),
    ]
